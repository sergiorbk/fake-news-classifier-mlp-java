...
public class BenchmarkRunner {
    public static void runBenchmark(String dataPath) throws Exception {
        ...
        SequentialLogisticRegression seqModel = new SequentialLogisticRegression(
                numFeatures, learningRate, iterations, batchSize, l2Lambda);
        ...
        System.out.println("Sequential Test Accuracy: " + seqAccuracy);
        ...
        System.out.println("Parallel Test Accuracy: " + parAccuracy);
